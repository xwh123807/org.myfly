  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: '/dynamic/:dynamicType/:windowName', name: 'dynamic-list', component: () => import('@/myfly/fly-multicachewindow') },
        { path: '/dynamic/:dynamicType/:windowName/:uid', name: 'dynamic-form', component: () => import('@/myfly/fly-multicachewindow') },
