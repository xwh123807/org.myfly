<template>
    <div>
      ...
      <el-date-picker v-else-if="column.dataType === 'DateTime'" type="datetime" v-model="data[column.model]" value-format="yyyy-MM-dd HH:mm:ss" style="width:100%"></el-date-picker>
      ...
      <fly-select-reflist v-else-if="column.dataType === 'List'" :model="column.model" :data="data" :element="column.element"></fly-select-reflist>
      ...
      <fly-select-table v-else-if="column.dataType === 'Table' || column.dataType === 'TableDirect'"
        :data="data" :model="column.model" :relationTable="column.relationTable" :relationKeyColumn="column.relationKeyColumn" 
        :relationDisplayColumn="column.relationDisplayColumn"></fly-select-table>
