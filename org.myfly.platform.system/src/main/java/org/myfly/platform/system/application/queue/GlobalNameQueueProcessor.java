...
import org.myfly.platform.core.flydata.queue.EntityMessage;
...
public class GlobalNameQueueProcessor {
	...
	public void receiveGlobalNameData(EntityMessage message) {
		GlobalName entity = (GlobalName) message.getEntity();
		try {
	 ...
	 * @param globalName
	 */
	public void sendGlobalNameData(EntityOperator operator, GlobalName globalName) {
