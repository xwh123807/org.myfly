...
public class VueConstants {
	...
	public static final String EL_TABLE_VIEW_HTML = "<el-table :data=\"{0}\" style=\"width: 100%\" stripe border highlight-current-row "
			+ "@row-click=\"rowClickHandler\" @row-dblclick=\"rowDoubleClickHandler\" {1}>{2}</el-table>";

	public static final String EL_COLUMN_VIEW_HTML = "<el-table-column prop=\"{0}\" label=\"{1}\" sortable></el-table-column>";

	public static final String DT_TABLE_VIEW_HTML = "";
}
