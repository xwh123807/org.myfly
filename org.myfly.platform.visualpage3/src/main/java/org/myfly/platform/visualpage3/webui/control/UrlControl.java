...
public class UrlControl extends BaseFieldControl{

	public UrlControl(FField field, ViewMode viewMode) {
		super(field, viewMode);
	}

	@Override
	public String htmlForEdit() {
		return MessageFormat.format(VueConstants.URL_EDIT_HTML, getPlaceholder(), getModel());
	}
