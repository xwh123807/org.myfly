...
public class CsvWriter {
	...
	/**
	 * Creates a {@link org.myfly.platform.system.utils.csv.csvreader.CsvWriter CsvWriter} object using a file
	...
	public CsvWriter(String fileName) {
		this(fileName, Letters.COMMA, Charset.forName("GB2312"));
	}

	/**
	 * Creates a {@link org.myfly.platform.system.utils.csv.csvreader.CsvWriter CsvWriter} object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	...
	/**
	 * Creates a {@link org.myfly.platform.system.utils.csv.csvreader.CsvWriter CsvWriter} object using an
