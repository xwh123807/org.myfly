...
public enum RefLists_ALL_EN {
	...
	A_Table_Rate_Type,
	//
	@FlyRefList(name="Java", description="Java", help="e.g. S - SQL", items={
	...
	AD_Message_Type,
	//
	@FlyRefList(name="项目", description="项目", items={
	@FlyRefItem(name="字段", value="F"),
	@FlyRefItem(name="文本", value="T"),
})
	AD_Print_Label_Line_Type,
	//
	@FlyRefList(name="用户 2", description="用户 2", items={
	...
	//
	@FlyRefList(name="用户 1", description="用户 1", items={
	...
	//
	@FlyRefList(name="退回材料 **", description="** 未完全实现 **", items={
	...
	M_InOutConfirm_Type,
	//
	@FlyRefList(name="周期类型", description="分期转变类型", items={
	@FlyRefItem(name="标准日历分期", value="S"),
	@FlyRefItem(name="调整分期", value="A"),
})
	C_Period_Type,
	//
	@FlyRefList(name="标准日历分期", description="Periods with non overlapping calendar days", items={
	@FlyRefItem(name="帐户", value="A"),
	@FlyRefItem(name="用户定义", value="U"),
})
	C_Element_Type,
	//
	@FlyRefList(name="调整分期", description="没有日历天的分期", items={
	...
	//
	@FlyRefList(name="帐户", description="会计科目", items={
	...
	//
	@FlyRefList(name="资产", description="资产 ( 资产负债表) 帐户", help="Determines which element to use as the base for the information", items={
	...
	AD_TreeType_Type,
	//
	@FlyRefList(name="负债", description="Liability (Balance Sheet) Account", help="Identify organizational entity physical location property or individual list", items={
	...
	//
	@FlyRefList(name="收入", description="收入 (P&L) Account", items={
	...
	//
	@FlyRefList(name="费用", description="费用 (P&L) Account", items={
	...
	//
	@FlyRefList(name="销售区域", description="销售区域", items={
	...
	APAR,
	//
	@FlyRefList(name="备忘录", description="备忘录 (非资产负债表也未 P&L) Account", items={
	...
	//
	@FlyRefList(name="M_TransactionAllocation Type", items={
	@FlyRefItem(name="LiFo", value="L"),
	@FlyRefItem(name="FiFo", value="F"),
})
	...
	CRM_Schedule,
	//
	@FlyRefList(name="后进先出", description="最近出货成本", items={
	...
	C_DocType_SubTypeSO,
	//
	@FlyRefList(name="AD_Print Graph Type", items={
	...
	_MRP_Order_Type,
	//
	@FlyRefList(name="先进先出", description="先进先出", items={
	...
	//
	@FlyRefList(name="债权", description="Encumbrance or Commitment Postings", items={
	...
	//
	@FlyRefList(name="Blind list (w o book quantity)", items={
	...
	//
	@FlyRefList(name="表单", description="特别的窗体", items={
	...
	//
	@FlyRefList(name="应付款信用备忘录", items={
	...
	//
	@FlyRefList(name="支票", items={
	@FlyRefItem(name="LiFo", value="L"),
	@FlyRefItem(name="FiFo", value="F"),
})
	_MMPolicy,
	//
	@FlyRefList(name="月", items={
	...
	//
	@FlyRefList(name="AD_Color Type", items={
	...
	C_Remuneration_Type,
	//
	@FlyRefList(name="国际的 GAAP", description="国际的 GAAP", items={
	...
	C_Order_InvoiceRule,
	//
	@FlyRefList(name="预算", description="预算过帐", items={
	...
	_PriorityRule,
	//
	@FlyRefList(name="实际", description="实际过帐", items={
	...
	//
	@FlyRefList(name="德国的 HGB", description="德国的 HGB", items={
	...
	//
	@FlyRefList(name="解锁", description="Unlock Transaction (process error)", items={
	...
	//
	@FlyRefList(name="Customer Schedule after Delivery", description="Invoice per Customer Invoice Schedule", items={
	@FlyRefItem(name="检查", value="C"),
	@FlyRefItem(name="储蓄", value="S"),
})
	C_Bank_Account_Type,
	//
	@FlyRefList(name="在收款之后", description="在收到现金之后", items={
	...
	C_Cash_Trx_Type,
	//
	@FlyRefList(name="平均ailability", description="As soon as an item becomes available", items={
	...
	//
	@FlyRefList(name="定单明细完成", description="As soon as all items of a line become available", items={
	@FlyRefItem(name="没有", value="N"),
	@FlyRefItem(name="追踪", value="F"),
})
	R_Request_Next_Action,
	//
	@FlyRefList(name="立即的", description="立即的发票", items={
	...
	//
	@FlyRefList(name="已包括运费", description="已包括运费", items={
	...
	AD_Role_User_Level,
	//
	@FlyRefList(name="低级", description="低优先权", items={
	...
	GL_Category_Type,
	//
	@FlyRefList(name="Dime .10, .20, .30, ...", items={
	...
	//
	@FlyRefList(name="Nickel .05, .10, .15, ...", items={
	...
	//
	@FlyRefList(name="Ten 10.00, 20.00, ..", items={
	...
	C_Payment_AVS,
	//
	@FlyRefList(name="在配送之后", description="每配送发票", items={
	...
	C_Payment_Trx_Type,
	//
	@FlyRefList(name="在定单配送之后", description="发票为每个定单", items={
	...
	//
	@FlyRefList(name="完成", description="Generate documents and complete transaction", items={
	@FlyRefItem(name="已批准", value="A"),
	@FlyRefItem(name="草稿", value="D"),
})
	GL_Budget_Status,
	//
	@FlyRefList(name="被拒", description="Reject the approval of the document. ", items={
	@FlyRefItem(name="错误", value="E"),
	...
	_ErrorType,
	//
	@FlyRefList(name="职位", description="过帐交易", help="Hardcoded Element Types", items={
	...
	//
	@FlyRefList(name="没有", description="没有汇率", items={
	...
	//
	@FlyRefList(name="AD_Print Area", items={
	...
	AD_Print_Area,
	//
	@FlyRefList(name="公司", description="公司率", items={
	...
	C_BP_EDI_EDI_Type,
	//
	@FlyRefList(name="用户类型", description="用户率类型", items={
	@FlyRefItem(name="草稿", value="D"),
	...
	M_EDI_Status,
	//
	@FlyRefList(name="手工比率", description="手工比率", items={
	@FlyRefItem(name="查询", value="I"),
	@FlyRefItem(name="采购定单", value="O"),
})
	M_EDI_Trx_Type,
	//
	@FlyRefList(name="信用定单", items={
	...
	_Payment_Rule,
	//
	@FlyRefList(name="<没有>", description="没有动作", items={
	...
	//
	@FlyRefList(name="PA_Report LineType", items={
	@FlyRefItem(name="表值", value="S"),
	@FlyRefItem(name="计算", value="C"),
	...
	A_Reval_Multiplier,
	//
	@FlyRefList(name="Quarter .25 .50 .75", items={
	...
	//
	@FlyRefList(name="结束", description="Finally close this transaction. It cannot be re-activated.", items={
	...
	_YesNo,
	//
	@FlyRefList(name="美国 GAAP", description="美国 GAAP", items={
